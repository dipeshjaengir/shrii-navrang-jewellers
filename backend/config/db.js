...
const connectDB = async () => {
  try {
    ...
    await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/shrii_navrang_jewellers', {
      serverSelectionTimeoutMS: 3000
    });
    console.log('✨ MongoDB Connected Successfully to Shrii Navrang Jewellers!');
  } catch (err) {
